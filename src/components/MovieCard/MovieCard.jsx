...
const formatReleaseDate = (releaseDate) => {
    ...
    try {
        ...
        return isNaN(date.getTime()) ? 'Unknown release date' : format(date, 'MMMM d, yyyy', { locale: enUS });
    } catch (error) {
        return 'Invalid date';
    }
};
...
const truncateText = (text, maxLength) => {
    ...
    truncated = (lastSpace > 0 && lastSpace > maxLength - 20) ? truncated.slice(0, lastSpace) : truncated;
    return truncated + '...';
};
...
const MovieCard = ({ movie, genres, onRateChange, userRating }) => {
    ...
    return (
        ...
        >
            ...
            {/* Area for all textual information and interactive elements */}
            <div className="movie-card-info-area">
                ...
                <p className="movie-card-description">
                    {truncateText(overview, MAX_DESCRIPTION_LENGTH)}
                </p>
